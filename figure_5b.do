...
*---------------------------------------------------------*
* Set global paths (based on current working directory)   *
*---------------------------------------------------------*
...
keep walkscore_1950 commute_1950 place_geoid10 mhousing_1950
...
foreach outcome in  walkscore commute mhousing {
...
gen pos1 = . 
replace pos1 = 0 if outcome=="walkscore" & spec1_b_

gen pos2 = .
replace pos2 = 0.25 if outcome=="walkscore" & spec2_b_

gen pos3 = .
replace pos3 = 0.5 if outcome=="walkscore" & spec3_b_

gen pos4 = .
replace pos4 = 0.75 if outcome=="walkscore" & spec4_b_

gen pos5 = .
replace pos5 = 1 if outcome=="walkscore" & spec5_b_
...
twoway (rcap ciup_1 cidown_1 pos1 if outcome == "walkscore", color(blue*.3) lwidth(medthick)) ///
    (rcap ciup_2 cidown_2 pos2 if outcome == "walkscore", color(orange*.3) lwidth(medthick)) ///
    (rcap ciup_3 cidown_3 pos3 if outcome == "walkscore", color(red*.3) lwidth(medthick)) ///
    (rcap ciup_4 cidown_4 pos4 if outcome == "walkscore", color(green*.3) lwidth(medthick)) ///
    (rcap ciup_5 cidown_5 pos5 if outcome == "walkscore", color(purple*.3) lwidth(medthick)) ///
    (scatter spec1_b_ pos1 if outcome == "walkscore", mcolor(blue*.9) msize(medium) ///
    ...
    (scatter spec2_b_ pos2 if outcome == "walkscore", mcolor(orange*0.9) msize(medium) ///
    ...
    (scatter spec3_b_ pos3 if outcome == "walkscore", mcolor(red*.9) msize(medium) ///
    ...
    (scatter spec4_b_ pos4 if outcome == "walkscore", mcolor(green*.9) msize(medium) ///
    ...
    (scatter spec5_b_ pos5 if outcome == "walkscore", mcolor(purple*.9) msize(medium) ///
    ...
    yline(0, lcolor(black)) ylabel(-1.5(0.5)1.5, labsize(medium)) ///
    xtitle("", size(large)) ///
    ytitle("", size(small)) subtitle("") ///
    title("{bf:a.} Walkscore index", size(medium)) ///
...
replace pos1 = 0 if outcome == "commute" & spec1_b_
replace pos2 = 0.25 if outcome == "commute" & spec2_b_
replace pos3 = 0.5 if outcome == "commute" & spec3_b_
replace pos4 = 0.75 if outcome == "commute" & spec4_b_
replace pos5 = 1 if outcome == "commute" & spec5_b_

* Second graph for street setback deviation
twoway (rcap ciup_1 cidown_1 pos1 if outcome == "commute", color(blue*.3) lwidth(medthick)) ///
    (rcap ciup_2 cidown_2 pos2 if outcome == "commute", color(orange*.3) lwidth(medthick)) ///
    (rcap ciup_3 cidown_3 pos3 if outcome == "commute", color(red*.3) lwidth(medthick)) ///
    (rcap ciup_4 cidown_4 pos4 if outcome == "commute", color(green*.3) lwidth(medthick)) ///
    (rcap ciup_5 cidown_5 pos5 if outcome == "commute", color(purple*.3) lwidth(medthick)) ///
    (scatter spec1_b_ pos1 if outcome == "commute", mcolor(blue*.9) msize(medium) ///
     mlab(label_coef1) mlabpos(6) mlabcolor(blue) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec1_b_ pos1 if outcome == "commute", mcolor(blue*.9) msize(medium) ///
     mlab(label_pval1) mlabpos(6) mlabcolor(blue) mlabsize(vsmall) mlabgap(8)) ///
    (scatter spec2_b_ pos2 if outcome == "commute", mcolor(orange*0.9) msize(medium) ///
     mlab(label_coef2) mlabpos(6) mlabcolor(orange) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec2_b_ pos2 if outcome == "commute", mcolor(orange*0.9) msize(medium) ///
     mlab(label_pval2) mlabpos(6) mlabcolor(orange) mlabsize(vsmall) mlabgap(8)) ///
    (scatter spec3_b_ pos3 if outcome == "commute", mcolor(red*.9) msize(medium) ///
     mlab(label_coef3) mlabpos(6) mlabcolor(red) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec3_b_ pos3 if outcome == "commute", mcolor(red*.9) msize(medium) ///
     mlab(label_pval3) mlabpos(6) mlabcolor(red) mlabsize(vsmall) mlabgap(8)) ///
    (scatter spec4_b_ pos4 if outcome == "commute", mcolor(green*.9) msize(medium) ///
     mlab(label_coef4) mlabpos(6) mlabcolor(green) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec4_b_ pos4 if outcome == "commute", mcolor(green*.9) msize(medium) ///
     mlab(label_pval4) mlabpos(6) mlabcolor(green) mlabsize(vsmall) mlabgap(8)) ///
    (scatter spec5_b_ pos5 if outcome == "commute", mcolor(purple*.9) msize(medium) ///
     mlab(label_coef5) mlabpos(6) mlabcolor(purple) mlabsize(vsmall) mlabgap(6)) ///
    (scatter spec5_b_ pos5 if outcome == "commute", mcolor(purple*.9) msize(medium) ///
     mlab(label_pval5) mlabpos(6) mlabcolor(purple) mlabsize(vsmall) mlabgap(9)), ///
    yline(0, lcolor(black)) ylabel(-0.2(0.1)0.2, labsize(medium)) ///
    xtitle("", size(large)) ///
    ytitle("", size(large)) subtitle("") ///
    title("{bf:b.} Log Commute distance", size(medium)) ///
    legend(off) ///
...
* Adjust positions for multi-family
replace pos1 = 0 if outcome == "mhousing" & spec1_b_
replace pos2 = 0.25 if outcome == "mhousing" & spec2_b_
replace pos3 = 0.5 if outcome == "mhousing" & spec3_b_
replace pos4 = 0.75 if outcome == "mhousing" & spec4_b_
replace pos5 = 1 if outcome == "mhousing" & spec5_b_

* Fourth graph for multi-family
twoway (rcap ciup_1 cidown_1 pos1 if outcome == "mhousing", color(blue*.3) lwidth(medthick)) ///
    (rcap ciup_2 cidown_2 pos2 if outcome == "mhousing", color(orange*.3) lwidth(medthick)) ///
    (rcap ciup_3 cidown_3 pos3 if outcome == "mhousing", color(red*.3) lwidth(medthick)) ///
    (rcap ciup_4 cidown_4 pos4 if outcome == "mhousing", color(green*.3) lwidth(medthick)) ///
    (rcap ciup_5 cidown_5 pos5 if outcome == "mhousing", color(purple*.3) lwidth(medthick)) ///
    (scatter spec1_b_ pos1 if outcome == "mhousing", mcolor(blue*.9) msize(medium) ///
     mlab(label_coef1) mlabpos(6) mlabcolor(blue) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec1_b_ pos1 if outcome == "mhousing", mcolor(blue*.9) msize(medium) ///
     mlab(label_pval1) mlabpos(6) mlabcolor(blue) mlabsize(vsmall) mlabgap(8)) ///
    (scatter spec2_b_ pos2 if outcome == "mhousing", mcolor(orange*0.9) msize(medium) ///
     mlab(label_coef2) mlabpos(6) mlabcolor(orange) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec2_b_ pos2 if outcome == "mhousing", mcolor(orange*0.9) msize(medium) ///
     mlab(label_pval2) mlabpos(6) mlabcolor(orange) mlabsize(vsmall) mlabgap(8)) ///
    (scatter spec3_b_ pos3 if outcome == "mhousing", mcolor(red*.9) msize(medium) ///
     mlab(label_coef3) mlabpos(6) mlabcolor(red) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec3_b_ pos3 if outcome == "mhousing", mcolor(red*.9) msize(medium) ///
     mlab(label_pval3) mlabpos(6) mlabcolor(red) mlabsize(vsmall) mlabgap(8)) ///
    (scatter spec4_b_ pos4 if outcome == "mhousing", mcolor(green*.9) msize(medium) ///
     mlab(label_coef4) mlabpos(6) mlabcolor(green) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec4_b_ pos4 if outcome == "mhousing", mcolor(green*.9) msize(medium) ///
     mlab(label_pval4) mlabpos(6) mlabcolor(green) mlabsize(vsmall) mlabgap(8)) ///
    (scatter spec5_b_ pos5 if outcome == "mhousing", mcolor(purple*.9) msize(medium) ///
     mlab(label_coef5) mlabpos(6) mlabcolor(purple) mlabsize(vsmall) mlabgap(5)) ///
    (scatter spec5_b_ pos5 if outcome == "mhousing", mcolor(purple*.9) msize(medium) ///
     mlab(label_pval5) mlabpos(6) mlabcolor(purple) mlabsize(vsmall) mlabgap(8)), ///
    yline(0, lcolor(black)) ylabel(-0.1(0.05)0.1, labsize(medium)) ///
    xtitle("", size(large)) ///
    ytitle("", size(large)) subtitle("") ///
    title("{bf:c.} Share Multi-Family Housing", size(medium)) ///
    legend(off) ///
    xlabel("", labsize(medium)) ///
    xscale(lstyle(none)) ///
    ysize(2) xsize(6) aspect(0.5) ///
...
gr combine p1 p2 p3, plotregion(fcolor(white)) graphregion(color(white)) rows(1) cols(2) xsize(8) ysize(6)

graph export "$figures_path/fig5_b.png", as(png) replace
